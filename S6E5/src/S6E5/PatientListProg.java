...
public class PatientListProg
{
   ...
   public static void main(String[] args)
   {
      ...
      listGlutenAllergies(patientList);
   }
   ...
   private static void listGlutenAllergies(NamedPatient[] aPatientList)
   {
       
       int numAllergicToGluten = 0;
       ...
       for (int index = 0; index < aPatientList.length; index++)
       {
           ...
           {
               numAllergicToGluten++;
               if (numAllergicToGluten == 1)
               {
                   System.out.print("\tPatients who are allergic to gluten:\n\n");
               }
               System.out.print("\t" + aPatientList[index].getName() + "\n");
           }
